...
@section('container')
    ...
    <div class="content">
        ...
        <div class="row">
            <form action="/dashboard/cetak_bm" method="post">
                @csrf
                <div class="row gy-2 gx-2 align-items-center">
                    ...
                    <div class="col-auto">
                        <button class="btn btn-info mb-2" id="lihatbm">Lihat</button>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 404) {
                            ...
                            console.log(response);
                            $.each(response.barang_masuk, function(key, item) {
                                $('tbody').append(
                                    '<tr>\
                                            <td>' + item.no_bm + '</td>\
                                            <td>' + item.tanggal_bm + '</td>\
                                            <td>' + item.total_bm + '</td>\
                                        </tr>'
                                );
                            });
