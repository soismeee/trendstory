        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Data Metode Bayar</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <div class="row">
            <div class="col-12 mb-3">
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#tambahjp"><i
                        class='uil uil-plus'></i> Tambah Metode Bayar</button>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-info">
                    <h4 class="modal-title" id="info-header-modalLabel">Form input Metode Bayar baru</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>
                <form action="/dashboard/save_metodebayar" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('nama_metode') is-invalid @enderror" id="floatingInput" value="{{ old('nama_metode') }}" name="nama_metode" placeholder="Masukan nama metode bayar" />
                            <label for="floatingInput">Nama Metode Bayar</label>
                        </div>
                    </div>

                    <div class="modal-body">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('no_rekening') is-invalid @enderror" id="floatingInput" value="{{ old('no_rekening') }}" name="no_rekening" placeholder="Masukan nomor rekening" />
        ...
        <div id="editjp-{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/dashboard/update_metodebayar/{{ $data->id }}" method="post">
                        @method('put')
                        @csrf
                        <div class="modal-body">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('nama_metode') is-invalid @enderror" id="floatingInput" value="{{ old('nama_metode', $data->nama_metode) }}" name="nama_metode" placeholder="Masukan nama metode bayar" />
                                <label for="floatingInput">Nama Metode Bayar</label>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('no_rekening') is-invalid @enderror" id="floatingInput" value="{{ old('no_rekening', $data->no_rekening) }}" name="no_rekening" placeholder="Masukan nomor rekening" />
                                <label for="floatingInput">Nomor Rekening</label>
                            </div>
                        </div>
                        <div class="modal-footer">
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            <form action="/dashboard/delete_metodebayar/{{ $data->id }}" method="post">
                                @method('delete')
                                @csrf
